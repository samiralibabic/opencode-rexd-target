...
echo "- Ensure target hosts run rexd v0.1.5 or newer."
echo "  Install/update on target host:"
echo "  curl -fsSL https://raw.githubusercontent.com/${REXD_REPO}/main/scripts/install.sh | REXD_VERSION=v0.1.5 bash"
